...
from fincapes.utils import (
    ...
    get_date_time_local, get_due_date_time,
    saved_directory_path
)
from fincapes.variables import (
    languages, USER_TYPE_CHOICES, USER_CATEGORY_CHOICES,
    GENDER_CHOICES
)
...
class Profile(models.Model):
    ...
    language = models.CharField(
        default=settings.LANGUAGE_CODE, choices=languages, max_length=3
    )
    photo = models.ImageField(upload_to=save_photo_avatar, null=True, blank=True)
...
class CroppingAvatar(models.Model):
...
#     uid = models.CharField(max_length=45, editable=False, unique=True, primary_key=True)
#     profile = models.ForeignKey(Profile, on_delete=models.CASCADE, null=True, blank=True, related_name='phone_numbers')
#     phone_no = models.CharField(max_length=20, null=True, blank=True)
#     is_wa_available = models.BooleanField(default=False)
#
#     def __str__(self):
